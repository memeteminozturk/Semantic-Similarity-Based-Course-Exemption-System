...
export default function Completion() {
  ...
  const selectedMatches = useSelector(state => state.wizard.selectedMatches); // Handle PDF download
        ...
        <Card title="Başvuruyu Tamamla" bordered={false}>
          ...
          <Row gutter={[0, 24]} justify="center">
              ...
              >
                ...
                <div style={{ marginTop: 16 }}>
                  <p>
                    ...
                    {personalInfo.studentId || 'ogrenci'}.pdf
                  </p>
                  <p>
                    <strong>Boyut:</strong>{' '}
                    {generatedPdf ? Math.round(generatedPdf.size / 1024) : 0} KB
                  </p>
                  <p>
            ...
            <Col xs={24} md={12} style={{ textAlign: 'center' }}>
              ...
              <p style={{ marginTop: 8 }}>
                Dilekçeyi doğrudan bölümünüze gönderin
              </p>
            </Col>
          </Row>
