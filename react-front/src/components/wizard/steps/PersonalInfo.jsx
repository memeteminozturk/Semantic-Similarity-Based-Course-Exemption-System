  ...
  return (
    <div>
        ...
        >
          ...
          <Row gutter={16}>
            <Col xs={24} sm={12}>
              <Form.Item
                ...
                rules={[
                  { required: true, message: 'Öğrenci numarası zorunludur!' },
                ]}
              >
                <Input
          ...
          <Row gutter={16}>
            <Col xs={24}>
              ...
              >
                <Input placeholder="Örn: Sivas Cumhuriyet Üniversitesi" />
              </Form.Item>
            </Col>
          </Row>
          <Row gutter={16}>
            <Col xs={24} sm={12}>
              <Form.Item
                ...
                rules={[
                  { required: true, message: 'Fakülte/MYO/YO zorunludur!' },
                ]}
              >
      ...
      <Card
        title={
          <>
            <FilePdfOutlined /> Eski Ders İçerikleri
          </>
        }
        extra={
          oldContentsFile && <CheckCircleOutlined style={{ color: 'green' }} />
        }
      ...
      >
        ...
        >
          ...
          <p>
            {oldContentsFile ? (
              <Text strong>
                Yüklendi: {oldContentsFile.name || 'ders_içerikleri.pdf'}
              </Text>
            ) : (
