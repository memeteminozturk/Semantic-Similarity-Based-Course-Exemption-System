...
export default function CourseExtraction() {
  ...
  return (
    <div>
      <Card
        title="Transkript'ten Çıkarılan Dersler"
        extra={
          <Button
            type="primary"
            icon={<PlusOutlined />}
      ...
      >
        ...
        {isParsingTranscript ? (
          <div style={{ textAlign: 'center', padding: '30px 0' }}>
            ...
            <p style={{ marginTop: 16 }}>
              Transkript işleniyor, dersler çıkarılıyor...
            </p>
                  ...
                  <Form.Item label="Kredi">
                    <Input
                      ...
                      onChange={e =>
                        setNewCourse({
                          ...newCourse,
                          nationalCredit: parseInt(e.target.value) || 0,
                        })
                      }
                    />
                  </Form.Item>
        ...
        {courses.length === 0 && (
          <div style={{ textAlign: 'center', padding: '20px' }}>
            <Text type="secondary">
              Henüz hiçbir ders eklenmemiş. "Ders Ekle" butonu ile manuel olarak
