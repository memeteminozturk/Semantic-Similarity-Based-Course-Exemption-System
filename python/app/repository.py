import json, pathlib, motor.motor_asyncio as motor
from typing import Dict, Optional

class CourseRepository:
    def __init__(self, src: str | None = "internal_courses.json", mongo_uri: str | None = None):
    ...
    async def load(self):
        if self._mongo:
            ...
            self._cache = {d["code"]: d.get("content", "")
